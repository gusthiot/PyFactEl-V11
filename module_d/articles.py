...
class Articles(CsvDict):
    ...
    cles = ['invoice-year', 'invoice-month', 'item-id', 'item-nbr', 'item-name', 'item-unit', 'item-idclass',
            'item-idsap', 'item-codeD', 'item-flag-usage', 'item-flag-conso', 'item-eligible', 'item-order',
            'item-labelcode', 'platf-code', 'item-extra']
    ...
    def __init__(self, imports):
        ...
        for cat in imports.categories.donnees.values():
            ...
            donnee = [self.imports.edition.annee, self.imports.edition.mois, cat['id_categorie'], cat['no_categorie'],
                      cat['intitule'], cat['unite'], cat['id_classe_prest'], classprest['id_article'], art['code_d'],
                      classprest['flag_usage'], classprest['flag_conso'], classprest['eligible'], art['ordre'],
        ...
        for prest in imports.prestations.donnees.values():
            ...
            donnee = [self.imports.edition.annee, self.imports.edition.mois, prest['id_prestation'],
                      prest['no_prestation'], prest['designation'], prest['unite_prest'], prest['id_classe_prest'],
