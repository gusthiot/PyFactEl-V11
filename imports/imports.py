...
class Imports(object):
    ...
    def __init__(self, dossier_source, destination, unique, short_path):
        ...
        if self.version > 0:
            ...
            self.transactions_2 = Transactions2(dossier_source, self.edition, self.plateforme, self.clients, self.comptes,
        ...
        self.chemin_report = Chemin.chemin([self.chemin_enregistrement, "REPORT"])
        ...
        Chemin.existe(self.chemin_report, True)
